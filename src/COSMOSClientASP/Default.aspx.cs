            ...
            chat.client.reply = function (serviceMessage) {
                ...
                if (serviceMessage.ProcessContext.ProcessType == 'Login') {
                    if (serviceMessage.UserContext != null) {
                        $('#discussion').append('<li>Login Sucessful for <strong>' + serviceMessage.UserContext.UserName + '</strong> Security Token: ' + serviceMessage.UserContext.SecurityToken + '</li>');
